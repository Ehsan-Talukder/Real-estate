...
class IndexController extends Controller
{
    ...
    {
        return view('frontend_landing.index_one');
    } // End Method

    public function Subteam($id)
    {
        $teams = LandingSubTeam::where('landing_main_team_id', $id)->get();

        return view('frontend_landing.sub_team.sub_team', compact('teams'));
    } // End Method
