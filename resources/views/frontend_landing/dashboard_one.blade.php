...
<head>
    ...
    <meta name="csrf-token" content="yg1oTrIsJyptoErWULFmL_n944ZjoLszG1TbKI_oUneyY1oE6mgeUADnA5ATwQdsysmJ3xfp8GdTIpFjwq4HLQ==" />
    <title>
        3D Homes Limited
    </title>

    <link rel="apple-touch-icon" sizes="72x72" href="/themes/real_estate/assets/img/apple-touch-icon.png" />
    <link rel="icon" type="image/png" href="/themes/real_estate/assets/img/favicon-32x32.png" sizes="32x32" />
    <link rel="icon" type="image/png" href="/themes/real_estate/assets/img/favicon-16x16.png" sizes="16x16" />
    <link rel="manifest" href="/themes/real_estate/assets/img/manifest.json" />
    <link rel="mask-icon" href="/themes/real_estate/assets/img/safari-pinned-tab.svg" color="#8b8232" />
    <link rel="shortcut icon" href="/themes/real_estate/assets/img/favicon.ico" />
    ...
    <meta name="description" content="Shanta Holdings Ltd. aspires to weave an unprecedented experience of fine living cocooned in comfort for you. It’s the statement of prestige and elegant Architecture that sets us apart." />
    <!-- <link href="https://shantaholdings.com/" rel="canonical"> -->
    <link href="assets/css/lightbox/ekko-lightbox.min.css" rel="stylesheet" />
    <link href="assets/css/home-map/map.css" rel="stylesheet" />
    <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,500,700" rel="preconnect" />
    <link href="assets/css/bundle.min.css" rel="stylesheet" media="all" />
    <link href="assets/css/layerslider.min.css" rel="stylesheet" media="all" />
    <link href="assets/css/style.min.css" rel="stylesheet" media="all" />
    <link href="assets/css/yt-lazyload.css" rel="stylesheet" media="all" />
...
<body>
    ...
    <body class="bodyclass">
        ...
        <noscript>
            <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PLG6CGJ" height="0" width="0" style="display: none; visibility: hidden"></iframe>
        </noscript>
        ...
        <script>
            ...
            !--Google Tag Manager(noscript) -- >
                // <noscript>
                // <iframe
                // src = "https://www.googletagmanager.com/ns.html?id=GTM-PLG6CGJ"
                // height = "0"
                // width = "0"
        ...
        <div class="site-main-wrapper">
                                        ...
                                        <div class="row">
                                            <div class="menu-wrapper">
                                                <div class="logo-wrapper">
                                                    <a href="https://shantaholdings.com" class="logo">
                                                        <img src="assets/img/logo.png" class="logo-img logo-dark" alt="Company Logo" />
                                                    </a>
                                                </div>
    
                                                <a href="#menu" class="btn btn-dark btn-lg mobile-menu-bar">
                                                    <img src="/themes/real_estate/assets/img/icons/menu.svg" alt="hamburger icon" />
                                                </a>
                                                    ...
                                                    <ul class="menu">
                                                        ...
                                                        <li style="">
                                                            ...
                                                            <ul class="submenu" style="display: none">
                                                                ...
                                                                <li>
                                                                    <a href="{{ url('/board_of_directors') }}">Board of Directors</a>
                                                                </li>
                                                        ...
                                                        <li style="">
                                                            <a class="open-search-menu" href="#search">
                                                                <span>
                                                                    <img src="/themes/real_estate/assets/img/icons/search.svg" alt="" />
                                                                </span>
                                                            </a>
                                                        </li>
                                                    </ul>
                    ...
                    <ul class="listview-icons">
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="mission-vision.php">Vision, Mission & Values</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul>
                                <li><a href="ongoing-projects.php">Ongoing</a></li>
                                <li><a href="upcoming-projects.php">Upcoming</a></li>
                                <li><a href="completed-projects.php">Completed</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="news.php"><span>News & Events</span></a>
                        </li>
                        <li>
                                ...
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="-265 377 40 40" style="enable-background: new -265 377 40 40" xml:space="preserve">
                                    ...
                                    <g id="XMLID_86_">
                                        ...
                                        <g id="search">
                                            ...
                                            s4-9,9-9s9,4,9,9S-242,404-247,404z"></path>
                                            </g>
                                        </g>
                                    </g>
                                </svg>
            ...
            <header class="site-main-header">
                <div class="menu-overlay search-result-menu" ng-app="shanta" ng-controller="searchCtrl">
                    ...
                    <div class="menu-column column-left has-inner-scroller" style="
                  ...
                  <div class="footer-social-wrapper pull-right">
                    <a target="_blank" href="#!">
                      <img
                        ...
                        alt="Shantaholdings-fb-page"
                      />
                    </a>
                    <a target="_blank" href="#!">
                      <img
                        src="assets/img/instagram-icon.png"
                        alt="Shantaholdings-instagram-page"
                      />
                    </a>
                    <a
                      target="_blank"
                      href="https://www.youtube.com/channel/UCH2kciy0CmoAiI20rU9KR7A"
                    >
                      <img
                        src="assets/img/youtube-icon.png"
                        alt="Shantaholdings-youtube-page"
                      />
                    </a>
                    <a target="_blank" href="#!">
                      <img
                        src="assets/img/pinterest-icon.png"
                        alt="Shantaholdings-pinterest-page"
                      />
                    </a>
                  </div>
                  <a
    ...
    defer
    ></script>
    <script src="assets/c901c4fe/yii.js"></script>
    <script src="assets/c901c4fe/yii.activeForm.js"></script>
    <script src="assets/js/upload_files.js"></script>
    <script src="assets/js/layerslider.transitions.js"></script>
    <script src="assets/js/layerslider.kreaturamedia.jquery.js"></script>
    <script src="assets/js/min/bundle.min.js"></script>
    <script src="assets/js/lg-video.js"></script>
    <script src="assets/js/yt-lazyload.min.js"></script>
