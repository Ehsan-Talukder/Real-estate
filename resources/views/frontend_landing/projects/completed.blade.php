                    ...
                    <div data-ref="mixitup-target"
                        ...
                        <a href="projects-detils.php">
                            <div class="relative" style="overflow: hidden">
                                    ...
                                    <div class="bg-thumb-inner" style="background-image: url('assets/img/completed.jpg')">

                                    </div>
                                </div>
                                <div class="thumb-desc">
                                    <h4 class="project-name">Northern Lights</h4>
                                    <span class="project-address">Road 69, Gulshan</span>
                                </div>
                            </div>
