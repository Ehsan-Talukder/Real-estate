...
@section('content')
    @php
        ...
        $projects = App\Models\Product::orderBy('id', 'DESC')->get();
    @endphp
    ...
    <section id="lands-to-landmark" class="section-gap parallax-container" data-stellar-background-ratio="0.1"
        style="background-image: url(assets/img/cy-sketch_background.jpg)">
                ...
                <div class="col-xs-12">
                    <div class="carousel-wrapper has-shadow">
                                        ...
                                        <a href="{{ url('project/details/' . $item->id) }}">
                                            <div class="image-thumb high-contrast">
                                                <img src="{{ asset($item->product_thambnail) }}"
                                                    alt="{{ $item->project_name }}" title="{{ $item->project_name }}" />
                                            </div>
                                            <h3 class="title">{{ $item->project_name }}</h3>
                                            <h5 class="sub-title">{{ $item->project_address }}</h5>
                                            <span class="read-more"> {{ $item->project_category }} </span>
                                        </a>
                                    </div>
                                </div>
                            @endforeach
                        ...
                        <div class="carousel-nav">
                            <img class="prev slick-prev" src="assets/img/icons/arrow_Dark_left.svg"
                                data-src="assets/img/icons/arrow_colored_left.svg" alt="Arrow left" />
                            <img class="next slick-next" src="assets/img/icons/arrow_Dark_right.svg"
                                data-src="assets/img/icons/arrow_colored_right.svg" alt="Arrow right" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="section-gap pt-100 bg-light-grey why-us pb-0 bg-cover-center parallax-container parallax-img"
        data-stellar-background-ratio="0.1" style="background-image: url(assets/img/BG-whyus.jpg)"
        data-image-src="/themes/real_estate/assets/img/images/BG-whyus-4.2.jpg">
        <div class="container-fluid">
            <div class="mb-30 hide">
                <h2 class="heading-primary text-white">WHY US</h2>
            </div>
            <div class="row pt-70 mobile-pt-0">
                <div class="col-sm-6 col-md-5">
                    ...
                    <div class="text-white">
                        <p>
                            3D Homes aspires to weave an unprecedented experience of fin
                            living cocooned in comfort for you. It’s the statement of
                            prestige and elegant Architecture that sets us apart.
                        </p>
                    </div>
                    <div class="mb-30">
                        <a href="#!" class="hidden-xs button button-outline button-outline-white mtb-30">
                            Explore
                        </a>
                    </div>
                    ...
                    <div class="bordered-tiles our-specility-lightbox-wrapper mobile-mb-0 stagger-wrapper mb-0">
                        <div class="row parent">
                            ...
                            <div class="col-xs-4 col-sm-6 col-md-4 borderd-tile-item mb-30 no-border sm">
                                <a href="#specility-lightbox-1" class="">
                                    <div class="inner">
                                        <div class="content">
                                            <div class="table-all">
                            ...
                            <div class="col-xs-4 col-sm-6 col-md-4 borderd-tile-item mb-30 no-border sm">
                                <a href="#specility-lightbox-2" class="">
                                    <div class="inner">
                                        <div class="content">
                                            <div class="table-all">
                                                <span class="vertical-center">
                            ...
                            <div class="col-xs-4 col-sm-6 col-md-4 borderd-tile-item mb-30 no-border sm">
                                <a href="#specility-lightbox-3" class="">
                                    <div class="inner">
                                        <div class="content">
                                            <div class="table-all">
                                                <span class="vertical-center">
                            ...
                            <div class="col-xs-4 col-sm-6 col-md-4 borderd-tile-item mb-30 no-border sm">
                                <a href="#specility-lightbox-4" class="">
                                    <div class="inner">
                                        <div class="content">
                                            <div class="table-all">
                                                <span class="vertical-center">
                            ...
                            <div class="col-xs-4 col-sm-6 col-md-4 borderd-tile-item mb-30 no-border sm">
                                <a href="#specility-lightbox-5" class="">
                                    <div class="inner">
                                        <div class="content">
                                            <div class="table-all">
                                                <span class="vertical-center">
                            ...
                            <div class="col-xs-4 col-sm-6 col-md-4 borderd-tile-item mb-30 no-border sm">
                                <a href="#specility-lightbox-6" class="">
                                    <div class="inner">
                                        <div class="content">
                                            <div class="table-all">
                                                <span class="vertical-center">
                        ...
                        <!--    <a href="//3D Homesholdings.com/why-3D Homes-holdings"-->
                        <!--        class="button button-outline button-outline-white mt-30 mb-100">-->
                        <!--        Explore-->
                        <!--    </a>-->
                        <!--</div>-->
                        ...
                        <!--            <img src="/themes/real_estate/assets/img/icons/global-menu-close-black.svg"-->
                        <!--                alt="close" />-->
                        <!--        </a>-->
                        <!--        <div class="inner">-->
                        ...
                        <!--                    synergy. At 3D Homes, delivering uncompromised quality,-->
    ...
    <section id="map-location" class="location-map-wrapper section-gap"
        style="background-image: url(assets/img/cy-sketch_background.jpg); padding-bottom: 0px;">
            ...
            <div class="row">
                ...
                <div class="col-sm-5" style="margin-bottom: 10px">
                    <div class="inner-addon right-addon">
                        ...
                        <input style="border-radius: 1.5rem; height: 50px; font-size: 15px" type="text"
                            class="form-control map-search-bar" id="search-bar"
                            placeholder="Type the Project name or Location" />
                    </div>
                </div>
                <div class="col-md-2">
                    <select style="border-radius: 1.5rem; height: 50px; margin-bottom: 10px" name=""
                ...
                <div class="col-md-2 mt-1">
                    <select style="border-radius: 1.5rem; height: 50px" name="" id="subCategory"
                        class="form-control">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header center">
                    ...
                    <center>
                        <img src="/admin/settings_images/logo-1488715861.svg" alt="Logo"
                            style="height: auto; width: 50%" />
                    </center>
                </div>
                <br />
                <div class="modal-body">
                    <h3 class="title text-bold text-uppercase text-wi" id="project-title" style="letter-spacing: 3px">
                    </h3>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" id="gallaryModalLoaderBtn">
                            <a href="#" class="nav-link" id="gallary-modal-loader" type="button" class="hidden"
                                data-toggle="modal" data-target="#gallaryModal">Gallery</a>
                        </li>
                    ...
                    <div class="modal-body">
                        <div class="form">
                            <input type="hidden" name="_csrf-frontend"
                                value="cDZBOVVyRXYgAxUNbBkiGxlVdVQcCzE6I1wGWBgdJh0vZCBQZhYfFw==" />
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" required name="Dynamicform[name]"
                                    id="name" placeholder="Your Name" />
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" required name="Dynamicform[email]"
                                    id="email" placeholder="E-mail address" />
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" required name="Dynamicform[phone]"
    ...
    <button id="gallary-modal-loader" type="button" class="hidden" data-toggle="modal"
        data-target="#gallaryModal"></button>
    ...
    <script>
        ...
        function initMap() {
            ...
            var productTitle = "3D Homes Western Tower";
            var features =
            ...
            var thisParams = {
                ...
                content: {
                    ...
                    features: features,
                    images: "<a href='' data-toggle='lightbox' data-gallery='mixedgallery'>                    <img src='/themes/real_estate/assets/img/video-thumbnail.jpg' width='200px' height='200px'>                </a><a href='/admin/uploads/product/3D Homes-virtue/1548226336GOisV.jpg' data-toggle='lightbox' data-gallery='mixedgallery'>                    <img src='/admin/uploads/product/3D Homes-virtue/1548226336GOisV.jpg' width='200px' height='200px'>                </a><a href='/admin/uploads/product/3D Homes-virtue/15482263363nGYH.jpg' data-toggle='lightbox' data-gallery='mixedgallery'>                    <img src='/admin/uploads/product/3D Homes-virtue/15482263363nGYH.jpg' width='200px' height='200px'>                </a><a href='/admin/uploads/product/3D Homes-virtue/15482263364sLG2.jpg' data-toggle='lightbox' data-gallery='mixedgallery'>                    <img src='/admin/uploads/product/3D Homes-virtue/15482263364sLG2.jpg' width='200px' height='200px'>                </a><a href='/admin/uploads/product/3D Homes-virtue/1548226336Untlq.jpg' data-toggle='lightbox' data-gallery='mixedgallery'>                    <img src='/admin/uploads/product/3D Homes-virtue/1548226336Untlq.jpg' width='200px' height='200px'>                </a><a href='/admin/uploads/product/3D Homes-virtue/1548226336gAdFa.jpg' data-toggle='lightbox' data-gallery='mixedgallery'>                    <img src='/admin/uploads/product/3D Homes-virtue/1548226336gAdFa.jpg' width='200px' height='200px'>                </a><a href='/admin/uploads/product/3D Homes-virtue/1548226336w2NEB.jpg' data-toggle='lightbox' data-gallery='mixedgallery'>                    <img src='/admin/uploads/product/3D Homes-virtue/1548226336w2NEB.jpg' width='200px' height='200px'>                </a>",
                    categoryId: "",
                    subCategoryId: "10",
                },
            };
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6 mb-30">
                    ...
                    <div class="">
                        <iframe width="100%" height="315" src="https://www.youtube.com/embed/kByCbBnFRm0"
                ...
                <div class="col-sm-6 mb-30">
                    <h2 class="mb-30">
                        <span><img class="social-icon" src="assets/img/so-ins-black.svg"
                                alt="Instagram" />Instagram</span>
                    </h2>
            ...
            <div class="premierProjectWrapper carousel-wrapper">
                <div class="premierProject premierInit">
                    <div class="premierProject__single">
                        ...
                        <a class="tvc-btn" target="_blank" href="https://www.3D Homespinnacle.com">
                            <img src="/admin/uploads/page/primary-project/1280x155/16254107042bZjP.jpg"
                                style="width: 100%" alt="" />
                        </a>
                    </div>
                </div>
                <div class="carousel-nav">
                    <img class="prev slick-prev" src="/themes/real_estate/assets/img/icons/arrow_Dark_left.svg"
                        data-src="/themes/real_estate/assets/img/icons/arrow_colored_left.svg" alt="Arrow left" />
                    <img class="next slick-next" src="/themes/real_estate/assets/img/icons/arrow_Dark_right.svg"
                        data-src="/themes/real_estate/assets/img/icons/arrow_colored_right.svg" alt="Arrow right" />
                </div>
            </div>
        </div>
    </section>
